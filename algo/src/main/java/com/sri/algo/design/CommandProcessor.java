...
public class CommandProcessor {
	...
	public static void main(String[] args) {
		...
		/**
		 * Tested with this sample input. 6 SET A 100 GET A SET B 200 GET B DELETE A
		 * DELETE B
		 * 
		 * 
		 * 
		 * Got this output.
		 * 
		 * SUCCESS 100 SUCCESS 200 SUCCESS SUCCESS
		 */

		CommandProcessor solution = new CommandProcessor();
