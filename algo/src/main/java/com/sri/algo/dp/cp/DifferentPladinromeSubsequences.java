...
public class DifferentPladinromeSubsequences {

	private Set<String> palidromeSet = new HashSet<>();
	
	/**
	 * Recursive solution ..
	 * 
	 * T.C : O(2 ^ n) where n is length of String.
	 * 
	 ...
	 * @return
	 */
	public int countPalindromicSubsequencesWithRecursion(String S) {
			
		countPalindromicSubsequencesWithRecursion(S,0,new StringBuilder());
		
		return palidromeSet.size() % (10^9 + 7);
	}
	
	private void countPalindromicSubsequencesWithRecursion(String s,int i,StringBuilder sb)
	{
		...
		if (!palidromeSet.contains(sb.toString()) && isPalindrome(sb.toString()))
		{
			palidromeSet.add(sb.toString());
		}
		
		countPalindromicSubsequencesWithRecursion(s, i +1, sb);		
	...
	public static void main(String[] args) {
		...
		DifferentPladinromeSubsequences dps = new DifferentPladinromeSubsequences();
		
		System.out.println(dps.countPalindromicSubsequences("bccb"));
		
		
		// Time limit exceeded with recursive solution..
		System.out.println(dps.countPalindromicSubsequences("abcdabcdabcdabcdabcdabcdabcdabcddcbadcbadcbadcbadcbadcbadcbadcba"));
